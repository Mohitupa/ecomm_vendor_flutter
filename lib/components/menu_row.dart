import 'package:ecom_bg_srs/models/menu_item.dart';
      ...
      children: [
        ...
        CupertinoButton(
          padding: menu.children.isNotEmpty
              ? const EdgeInsets.symmetric(vertical: 0, horizontal: 16) : const EdgeInsets.all(12),
                  ...
                  children: [
                    for (var subMenu in menu.children) ...[
                      ListTile(
                        ...
                        contentPadding: const EdgeInsets.symmetric(vertical: 0, horizontal: 42),
                        onTap: onMenuPressed,
                      ),
                    ],
                  ],
